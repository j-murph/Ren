...
struct Matrix4x4
{
	...
	Matrix4x4<T> operator*(const Matrix4x4<T>& other) const
	{
		...
		Matrix4x4<T> temp;
		temp.a[0][0] = a[0][0] * o.a[0][0] + a[1][0] * o.a[0][1] + a[2][0] * o.a[0][2] + a[3][0] * o.a[0][3];
		temp.a[1][0] = a[0][0] * o.a[1][0] + a[1][0] * o.a[1][1] + a[2][0] * o.a[1][2] + a[3][0] * o.a[1][3];
		temp.a[2][0] = a[0][0] * o.a[2][0] + a[1][0] * o.a[2][1] + a[2][0] * o.a[2][2] + a[3][0] * o.a[2][3];
		temp.a[3][0] = a[0][0] * o.a[3][0] + a[1][0] * o.a[3][1] + a[2][0] * o.a[3][2] + a[3][0] * o.a[3][3];
		temp.a[0][1] = a[0][1] * o.a[0][0] + a[1][1] * o.a[0][1] + a[2][1] * o.a[0][2] + a[3][1] * o.a[0][3];
		temp.a[1][1] = a[0][1] * o.a[1][0] + a[1][1] * o.a[1][1] + a[2][1] * o.a[1][2] + a[3][1] * o.a[1][3];
		temp.a[2][1] = a[0][1] * o.a[2][0] + a[1][1] * o.a[2][1] + a[2][1] * o.a[2][2] + a[3][1] * o.a[2][3];
		temp.a[3][1] = a[0][1] * o.a[3][0] + a[1][1] * o.a[3][1] + a[2][1] * o.a[3][2] + a[3][1] * o.a[3][3];
		temp.a[0][2] = a[0][2] * o.a[0][0] + a[1][2] * o.a[0][1] + a[2][2] * o.a[0][2] + a[3][2] * o.a[0][3];
		temp.a[1][2] = a[0][2] * o.a[1][0] + a[1][2] * o.a[1][1] + a[2][2] * o.a[1][2] + a[3][2] * o.a[1][3];
		temp.a[2][2] = a[0][2] * o.a[2][0] + a[1][2] * o.a[2][1] + a[2][2] * o.a[2][2] + a[3][2] * o.a[2][3];
		temp.a[3][2] = a[0][2] * o.a[3][0] + a[1][2] * o.a[3][1] + a[2][2] * o.a[3][2] + a[3][2] * o.a[3][3];
		temp.a[0][3] = a[0][3] * o.a[0][0] + a[1][3] * o.a[0][1] + a[2][3] * o.a[0][2] + a[3][3] * o.a[0][3];
		temp.a[1][3] = a[0][3] * o.a[1][0] + a[1][3] * o.a[1][1] + a[2][3] * o.a[1][2] + a[3][3] * o.a[1][3];
		temp.a[2][3] = a[0][3] * o.a[2][0] + a[1][3] * o.a[2][1] + a[2][3] * o.a[2][2] + a[3][3] * o.a[2][3];
		temp.a[3][3] = a[0][3] * o.a[3][0] + a[1][3] * o.a[3][1] + a[2][3] * o.a[3][2] + a[3][3] * o.a[3][3];
		return temp;
	}
